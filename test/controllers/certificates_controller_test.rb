...
class CertificatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post certificates_url, params: { certificate: { code: @certificate.code, name: @certificate.name } }
    end
  ...
  test "should update certificate" do
    patch certificate_url(@certificate), params: { certificate: { code: @certificate.code, name: @certificate.name } }
